...
print GREEN+"                       WWW          "
print GREEN+"                      WWWWW        "
print GREEN+"                W     WWWWW     W  "
print GREEN+"                WWW   WWWWW   WWW  "
print GREEN+"                 WWW  WWWWW  WWW    "
print GREEN+"                  WWW  WWW  WWW    "
print GREEN+"                   WWW WWW WWW      "
print GREEN+"                     WWWWWWW     "   
print GREEN+"                  WWWW  |  WWWW "   
print GREEN+"                        |  "        
print ""
print BUS+"         'COMMON USER PASSWORD LIST CREATOR'"
print PURPLE+"       *********[CREATED BY:]***********"
print PURPLE+"   _____          _______               .__    _______                 "
print PURPLE+"  /  _  \   _____ \   _  \_____________ |  |__ \   _  \  __ __  ______ "
print PURPLE+" /  /_\  \ /     \/  /_\  \_  __ \____ \|  |  \/  /_\  \|  |  \/  ___/ "
print PURPLE+"/    |    \  Y Y  \  \_/   \  | \/  |_> >   Y  \  \_/   \  |  /\___ \ " 
print PURPLE+"\____|__  /__|_|  /\_____  /__|  |   __/|___|  /\_____  /____//____  >  "
print PURPLE+"        \/      \/       \/      |__|        \/       \/           \/  "
print ""
print ""
...
print BUS+"[*]"+WHITE+" Saving dictionary to "+GREEN+"[opensource/files/"+name+".txt]"+WHITE+", counting "+GREEN+"["+str(lines)+"]"+WHITE+" words."
